...
function preload(){
  trex_running =   loadAnimation("obstacle1.png","obstacle2.png","obstacle6.png");
...
function draw() {
 ...
 // trex.y=camera.position.y
  if (gameState===PLAY){
    ...
    if(obstaclesGroup.isTouching(trex)||score===700){
        gameState = END;
    }
  }
  else if (gameState === END) {
    gameover=camera.position.x
    restart=camera.position.x
